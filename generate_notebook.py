    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "dl_script = dl_script.replace('https://datashare.ed.ac.uk/bitstream/handle/10283/2791/clean_testset_wav.zip', 'https://datashare.ed.ac.uk/bitstreams/dec213d3-bf57-4777-9663-c24bdce92d5e/download')\n",
                "dl_script = dl_script.replace('https://datashare.ed.ac.uk/bitstream/handle/10283/2791/noisy_testset_wav.zip', 'https://datashare.ed.ac.uk/bitstreams/13c1bfbf-14a6-41db-9b41-8f7310f01ad5/download')\n",
