...
# Ensure script runs relative to project root since it was moved to scripts/dev/
...
notebook = {
    "cells": [
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 5. Evaluate Fine-Tuned Model\n"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 7. Package and Export Artifacts\n"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
