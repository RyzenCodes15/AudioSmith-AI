...
class BenchmarkResult:
    ...
    def __repr__(self) -> str:
        lines = [
            ...
            f"  SI-SDR:  {self.avg_si_sdr:.2f} dB"
            if self.avg_si_sdr
            else "  SI-SDR:  N/A",
...
class BenchmarkRunner:
    ...
    def run(self) -> BenchmarkResult:
        ...
        dataset = ValidationDataset(
            ...
            duration=3.0,  # Or evaluate on full length
        )
        ...
        return BenchmarkResult(
            ...
            avg_pesq=metrics_sum["pesq"] / counts["pesq"]
            if counts["pesq"] > 0
            else None,
            avg_stoi=metrics_sum["stoi"] / counts["stoi"]
            if counts["stoi"] > 0
            else None,
            avg_si_sdr=metrics_sum["si_sdr"] / counts["si_sdr"]
            if counts["si_sdr"] > 0
            else None,
